...
data class CommonGenerator(val dictionary: Map<String, Any>, val androidRPackage: String, val packageName: String?, val defaultLanguage: String) {
    fun generate(): CommonGenerated {
        val packageDeclaration = packageName?.let { "package $it\n\n" }
        val generated = CommonGenerated(dictionary, androidRPackage, packageDeclaration, defaultLanguage)
        generated.generate()
        return generated
    }
}
